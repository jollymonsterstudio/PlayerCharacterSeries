...
//////////////////////////////////////////////////////////////////////////
// AMovement02Character

AMovement02Character::AMovement02Character()
{
...
void AMovement02Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AMovement02Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AMovement02Character::OnAttackHit);
...
void AMovement02Character::Tick(float DeltaTime)
{
...
void AMovement02Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AMovement02Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AMovement02Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AMovement02Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AMovement02Character::LookUpAtRate);

	PlayerInputComponent->BindAction("ArmPlayer", IE_Pressed, this, &AMovement02Character::ArmPlayerImmediately);
	PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &AMovement02Character::CrouchStart);
	PlayerInputComponent->BindAction("Crouch", IE_Released, this, &AMovement02Character::CrouchEnd);

	PlayerInputComponent->BindAction("Run", IE_Pressed, this, &AMovement02Character::RunStart);
	PlayerInputComponent->BindAction("Run", IE_Released, this, &AMovement02Character::RunEnd);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AMovement02Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AMovement02Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AMovement02Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AMovement02Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AMovement02Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AMovement02Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AMovement02Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AMovement02Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AMovement02Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("FireTrace", IE_Pressed, this, &AMovement02Character::FireLineTrace);
	
}

void AMovement02Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AMovement02Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AMovement02Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AMovement02Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AMovement02Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AMovement02Character::MoveForward(float Value)
{
	MoveForwardValue = Value;

	if ((Controller != NULL) && (Value != 0.0f) && bIsKeyboardEnabled)
	{
...
void AMovement02Character::MoveRight(float Value)
{
...
bool AMovement02Character::IsRunning()
{
	return bIsRunning;
}

float AMovement02Character::GetMoveRight()
{
	return MoveRightValue;
}

float AMovement02Character::GetMoveForward()
{
	return MoveForwardValue;
}

bool AMovement02Character::IsAnimationBlended()
{
	return bIsAnimationBlended;
}

bool AMovement02Character::IsArmed()
{
	return bIsArmed;
}

void AMovement02Character::SetIsKeyboardEnabled(bool Enabled)
{
	bIsKeyboardEnabled = Enabled;
}

EAttackType AMovement02Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AMovement02Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AMovement02Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AMovement02Character::AttackInput(EAttackType AttackType)
{
...
void AMovement02Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AMovement02Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
	...
	//GetWorld()->GetTimerManager().SetTimer(ArmedToIdleTimerHandle, this, &AMovement02Character::TriggerCountdownToIdle, 1.f, true);
}

void AMovement02Character::LightAttackStart()
{
	bIsAttackLight = true;
}

void AMovement02Character::LightAttackEnd()
{
	bIsAttackLight = false;
}

void AMovement02Character::StrongAttackStart()
{
	bIsAttackStrong = true;
}

void AMovement02Character::StrongAttackEnd()
{
	bIsAttackStrong = false;
}

void AMovement02Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (InGameHUD)
	{
		...
		if (!GetWorld()->GetTimerManager().IsTimerActive(ComboResetTimerHandle)) {
			GetWorld()->GetTimerManager().SetTimer(ComboResetTimerHandle, this, &AMovement02Character::ResetCombo, 5.1f, true);
		}
		else {
...
void AMovement02Character::ResetCombo()
{
	CurrentCombo = 0;
	// update hud
	AInGameHUD* InGameHUD = Cast<AInGameHUD>(GetWorld()->GetFirstPlayerController()->GetHUD());
...
void AMovement02Character::TriggerCountdownToIdle()
{
...
void AMovement02Character::ArmPlayerImmediately()
{
	// flip flop the values
	ArmPlayer(!bIsArmed);
}

void AMovement02Character::ArmPlayer(bool Value)
{
	// flip / flop
	bIsArmed = Value;
...
void AMovement02Character::RunStart()
{
...
void AMovement02Character::RunEnd()
{
	if (!bIsCrouched && !bIsArmed)
	{
		bIsRunning = false;
...
void AMovement02Character::CrouchStart()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AMovement02Character::CrouchEnd()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AMovement02Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AMovement02Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AMovement02Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
