...
//////////////////////////////////////////////////////////////////////////
// AMovement01Character

AMovement01Character::AMovement01Character()
{
...
void AMovement01Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AMovement01Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AMovement01Character::OnAttackHit);
...
void AMovement01Character::Tick(float DeltaTime)
{
...
void AMovement01Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AMovement01Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AMovement01Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AMovement01Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AMovement01Character::LookUpAtRate);

	PlayerInputComponent->BindAction("ArmPlayer", IE_Pressed, this, &AMovement01Character::ArmPlayer);
	PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &AMovement01Character::CrouchStart);
	PlayerInputComponent->BindAction("Crouch", IE_Released, this, &AMovement01Character::CrouchEnd);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AMovement01Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AMovement01Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AMovement01Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AMovement01Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AMovement01Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AMovement01Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AMovement01Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AMovement01Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AMovement01Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("FireTrace", IE_Pressed, this, &AMovement01Character::FireLineTrace);
	
}

void AMovement01Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AMovement01Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AMovement01Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AMovement01Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AMovement01Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AMovement01Character::MoveForward(float Value)
{
...
void AMovement01Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) && bIsKeyboardEnabled )
	{
...
bool AMovement01Character::IsAnimationBlended()
{
	return bIsAnimationBlended;
}

bool AMovement01Character::IsArmed()
{
	return bIsArmed;
}

void AMovement01Character::SetIsKeyboardEnabled(bool Enabled)
{
	bIsKeyboardEnabled = Enabled;
}

EAttackType AMovement01Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AMovement01Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AMovement01Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AMovement01Character::AttackInput(EAttackType AttackType)
{
...
void AMovement01Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AMovement01Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
	...
	GetWorld()->GetTimerManager().SetTimer(ArmedToIdleTimerHandle, this, &AMovement01Character::TriggerCountdownToIdle, 1.f, true);
}

void AMovement01Character::LightAttackStart()
{
	bIsAttackLight = true;
}

void AMovement01Character::LightAttackEnd()
{
	bIsAttackLight = false;
}

void AMovement01Character::StrongAttackStart()
{
	bIsAttackStrong = true;
}

void AMovement01Character::StrongAttackEnd()
{
	bIsAttackStrong = false;
}

void AMovement01Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (InGameHUD)
	{
		...
		if (!GetWorld()->GetTimerManager().IsTimerActive(ComboResetTimerHandle)) {
			GetWorld()->GetTimerManager().SetTimer(ComboResetTimerHandle, this, &AMovement01Character::ResetCombo, 5.1f, true);
		}
		else {
...
void AMovement01Character::ResetCombo()
{
	CurrentCombo = 0;
	// update hud
	AInGameHUD* InGameHUD = Cast<AInGameHUD>(GetWorld()->GetFirstPlayerController()->GetHUD());
...
void AMovement01Character::TriggerCountdownToIdle()
{
...
void AMovement01Character::ArmPlayer()
{
	// flip / flop
	bIsArmed = !bIsArmed;
...
void AMovement01Character::CrouchStart()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
	Crouch();
}

void AMovement01Character::CrouchEnd()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
	UnCrouch();
}

void AMovement01Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AMovement01Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AMovement01Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
